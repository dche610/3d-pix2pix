...
if __name__ == "__main__":
    ...
    list_masks = lstFiles(args.masks)
    ...
    for i in range(len(list_images)-int(args.split)):
        ...
        save_directory_masks = './Data_folder/train/masks'
        ...
        c = list_masks[int(args.split)+i]

        print(a)

        label = sitk.ReadImage(b)
        image = sitk.ReadImage(a)
        mask = sitk.ReadImage(c)
